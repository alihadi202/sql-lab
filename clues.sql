...
WHERE countrycode !='VAT' AND language = 'Italian' AND countrycode NOT IN (
...
-- Write SQL query here
SELECT * FROM cities WHERE countrycode ='SMR' AND name NOT IN(
  SELECT name FROM cities WHERE name IN(
...
SELECT name FROM cities WHERE countrycode = 'BRA' AND id =211;
